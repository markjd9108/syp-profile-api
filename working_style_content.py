...
COMPLEMENTS = {
    ...
    "Considered & Thorough":   {"style": "Direct & To-the-Point",
        "reason": "You like to think things through carefully. They like to move faster and focus on the main point. Together, your careful thinking turns into clear decisions."},
    "Direct & To-the-Point":   {"style": "Warm & Attuned",
        "reason": "You get to the point and keep things moving. They watch how people feel and how a message is received. Together, you move fast and still keep people comfortable."},
    "Warm & Attuned":          {"style": "Direct & To-the-Point",
        "reason": "You care about people and notice how they feel. They are clear and like to keep moving. Together, your care for people turns into clear decisions made on time."},
    ...
    "Consultative & Inclusive":{"style": "Decisive & Committed",
        "reason": "You like to ask others and build agreement. They help make the final choice once the talking is done. Together, you reach a decision instead of talking for too long."},
    "Adaptive & Iterative":    {"style": "Measured & Analytical",
        "reason": "You like to adjust as you learn. They give a steady plan and a clear sense of what matters most. Together, your flexible style has a solid base."},
    # Collaboration
    ...
    "Candid & Open":           {"style": "Flexible & Versatile",
        "reason": "You speak openly, even about hard things. They adjust and keep the team moving. Together, your honesty helps the team improve without causing conflict."},
}
