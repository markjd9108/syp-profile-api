...
COMPLEMENTS = {
    # Communication
    "Considered & Thorough":   {"style": "Direct & To-the-Point",
        "reason": "Where you go deep and take your time to get it right, they bring pace and a bias for the bottom line — so your thinking lands as a clear decision, not just a thorough discussion."},
    "Direct & To-the-Point":   {"style": "Warm & Attuned",
        "reason": "Where you get to the point and keep things moving, they read the room and tend to how a message lands — so things move quickly without anyone feeling steamrolled."},
    "Warm & Attuned":          {"style": "Direct & To-the-Point",
        "reason": "Where you keep the room with you and read how things land, they bring directness and momentum — so your care for people turns into clear, timely calls."},
    "Curious & Questioning":   {"style": "Considered & Thorough",
        "reason": "Where you open things up with questions, they bring structure and follow-through — so all that exploring settles into a clear, organised view the team can act on."},
    # Decision-Making
    "Measured & Analytical":   {"style": "Decisive & Committed",
        "reason": "Where you weigh the options and look for a sound basis, they bring the nerve to commit and move — so strong analysis turns into momentum instead of more analysis."},
    "Decisive & Committed":    {"style": "Measured & Analytical",
        "reason": "Where you make the call and move, they bring the careful read and the risks worth a second look — so your speed stays paired with sound judgment."},
    "Consultative & Inclusive":{"style": "Decisive & Committed",
        "reason": "Where you draw people in and build agreement, they help land the call once the thinking is done — so collaboration produces a decision rather than an endless conversation."},
    "Adaptive & Iterative":    {"style": "Measured & Analytical",
        "reason": "Where you adjust and refine as you learn, they bring a steady baseline and a clear read of the stakes — so your flexibility has solid ground to build on."},
    # Collaboration
    "Self-Directed & Focused": {"style": "Close & Collaborative",
        "reason": "Where you own your lane and deliver, they bring the build-together energy that keeps people connected — so focused individual work still plugs into the wider team."},
    "Close & Collaborative":   {"style": "Self-Directed & Focused",
        "reason": "Where you build in constant exchange, they bring independent drive and clear ownership — so all that collaboration turns into decisions and output, not just discussion."},
    "Flexible & Versatile":    {"style": "Candid & Open",
        "reason": "Where you adapt to whatever the team needs, they put the real issues on the table — so your flexibility helps the group move without ever smoothing over what matters."},
    "Candid & Open":           {"style": "Flexible & Versatile",
        "reason": "Where you name what others avoid, they adapt and keep things moving — so honesty lands as progress rather than friction, and hard truths actually get used."},
}
